...
class Compose {
public:
  vector<string> types = {"Ionique", "Moléculaire", "Acide", "Base"};
  int charge;
  string type;
  bool stable;
  string formule;
...
Element* Hydrogene = new Element("H", "Hydrogène", 1, 1, -1);
Element* Helium = new Element("He", "Hélium", 2, 4, 0);
Element* Lithium = new Element("Li", "Lithium", 3, 7, 1);
Element* Beryllium = new Element("Be", "Béryllium", 4, 9, 2);
...
Element* Oxygene = new Element("O", "Oxygène", 8, 16, -2);
Element* Fluor = new Element("F", "Fluor", 9, 16, -1);
Element* Neon = new Element("Ne", "Néon", 10, 20, 0);
Element* Sodium = new Element("Na", "Sodium", 11, 23, 1);
Element* Magnesium = new Element("Mg", "Magnésium", 12, 24, 2);
...
Element* Manganese = new Element("Mn", "Manganèse", 25, 55, 3);
...
Element* Selenium = new Element("Se", "Sélénium", 34, 79, -2);
...
Element* Molybdene = new Element("Mo", "Molybdène", 42, 96, 3);
Element* Technetium = new Element("Tc", "Technétium", 43, 98, 7);
Element* Ruthenium = new Element("Ru", "Ruthénium", 44, 102, 4);
...
Element* Etain = new Element("Sn", "Étain", 50, 119, 4);
...
Element* Xenon = new Element("Xe", "Xénon", 54, 131, 0);
...
Element* Praseodyme = new Element("Pr", "Praséodyme", 59, 141, 4, 0);
Element* Neodyme = new Element("Nd", "Néodyme", 60, 144, 3);
Element* Promethium = new Element("Pm", "Prométhium", 61, 145, 3, 0);
...
Element* Tungstene = new Element("W", "Tungstène", 74, 184, 6);
Element* Rhenium = new Element("Re", "Rhénium", 75, 186, 7);
...
Element* Berkelium = new Element("Bk", "Berkélium", 97, 247, 4, 0);
...
Element* Mendelevium = new Element("Md", "Mendélévium", 101, 258, 3, 0);
Element* Nobelium = new Element("No", "Nobélium", 102, 259, 3, 0);
...
Element* Meithnerium = new Element("Mt", "Meithnérium", 109, 268, 0);
Element* Darmstadtium = new Element("Ds", "Darmastadium", 110, 281, 0);
Element* Roentgenium = new Element("Rg", "Roentgenium", 111, 280, 0);
Element* Copernicium = new Element("Cn", "Copernicium", 112, 285, 0);
Element* Ununtrium = new Element("Nh", "Nihonium", 113, 284, 0);
Element* Flerovium = new Element("Fl", "Flérovium", 114, 289, 0);
Element* Ununpentium = new Element("Mc", "Moscovium", 115, 288, 0);
Element* Livermorium = new Element("Lv", "Livermorium", 116, 293, 0);
Element* Ununseptium = new Element("Ts", "Tennesse", 117, 291, 0);
Element* Ununoctium = new Element("Og", "Oganesson", 118, 294, 0);
